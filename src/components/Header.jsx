...
const Header = () => {
  ...
  return (
    <header className="flex justify-between items-center shadow-md px-6 py-4">
      <div
        onClick={() => navigate('/')}
        className="flex items-center gap-2 text-xl font-bold text-blue-800 cursor-pointer"
      >
        {/* Replace emoji with logo if needed */}
      ...
      <button onClick={()=>navigate('/login')} className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm">
        Get Started
      </button>
    </header>
  );
